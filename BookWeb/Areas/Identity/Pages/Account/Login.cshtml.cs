...
namespace BookWeb.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<BookWebUser> signInManager, ILogger<LoginModel> logger, UserManager<BookWebUser> userManager)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    else
                    {
                        ...
                        ModelState.AddModelError(string.Empty, "Input Correct Password");
                        return Page();
                    }
                }
            }
